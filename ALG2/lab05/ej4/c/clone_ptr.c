...
/*
No entiendo lo que tengo que hacer ya que clone.c desde el kickstart la variable original
viene declarada exactamente como la estan pidiendo que la cambie
*/